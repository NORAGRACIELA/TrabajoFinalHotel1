        ...
        <div className='container'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            <h1>HISTORIA</h1>
                            <h5>En 1829, el arquitecto Isaiah Rogers
                            ...
                            allá de los recursos del ciudadano medio.</h5>
                            <h3>VER FOTOS</h3>
                            <div className='row'>
                                <div className='col-2'>
                                    <img className= "w-100" src='https://firebasestorage.googleapis.com/v0/b/frontcomfamangh.appspot.com/o/habitacio4.jpg?alt=media&token=32930c88-609d-41c5-b8ac-d4104e54a6b0' height="200"/>

                                </div>
                                <div className='col-2'>
                                    <img className="w-100" src='https://firebasestorage.googleapis.com/v0/b/frontcomfamangh.appspot.com/o/HABITACION-halHD2.jpg?alt=media&token=c65e4f46-89b5-4cd2-9dad-f037ab466652' height="200"/>

                                </div>
                                <div className='col-2'>
                                    <img className= "w-100" src='https://firebasestorage.googleapis.com/v0/b/frontcomfamangh.appspot.com/o/HABITACION-halHD3.jpg?alt=media&token=72866c58-5da5-4869-a50a-41722762eea4' height="200"/>
                                </div>
